    ...
    def add_slime_arguments(parser):
        ...
        def add_cluster_arguments(parser):
            ...
            parser.add_argument(
                ...
                type=int,
                default=1,
                help="Number of GPUs per inference engine (tensor-parallel size).",
            )
            parser.add_argument(
                "--num-gpus-per-node",
                type=int,
        ...
        def add_rollout_arguments(parser):
            ...
            parser.add_argument(
                ...
                help=(
                    ...
                    "It is basically `max_tokens` in the rollout engine."
                ),
            )
            parser.add_argument(
        ...
        def add_on_policy_distillation_arguments(parser):
            ...
            parser.add_argument(
                ...
                help=(
                    ...
                    "'vllm': Teacher log-probs are obtained from an external vLLM server during rollout. "
...
def slime_validate_args(args):
        ...
        if args.opd_type == "megatron":
            ...
            if args.opd_teacher_load is not None:
                raise ValueError(
                    ...
                    "In vllm mode, teacher log-probs are obtained from an external vLLM server during rollout."
                )
    else:
    ...
    if args.load_debug_rollout_data is not None:
        logger.info(
            ...
            "will not instantiate rollout engines and will only run the training process."
        )
