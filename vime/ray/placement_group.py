...
def create_rollout_manager(args, pg):
    ...
    if args.check_weight_update_equal:
        ray.get(rollout_manager.check_weights.remote(action="snapshot", stage="rollout_startup"))
        ray.get(rollout_manager.check_weights.remote(action="reset_tensors", stage="rollout_startup"))
